...
class My_Object {
    ...
    father_name;
    email;
    constructor(name, father_name, email) {
        this.name = name;
...
*/
let favotite_fruite = ["Apple", "Banana", "Cheery", "Grapes"];
console.log(favotite_fruite);
if (favotite_fruite.includes("Banana"))
    console.log("You really like bananas!");
if (favotite_fruite.includes("Apple"))
    console.log("You really like Apple!");
if (favotite_fruite.includes("Cheery"))
    console.log("You really like Cheery!");
if (favotite_fruite.includes("Grapes"))
...
*/
let user_names = ["Admin", "Umer Aftab Bhai", "Osama", "Saad Ali"];
