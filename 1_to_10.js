...
let message = `${famous_person}once said, A person who never made a mistake never tried anythig new`;
console.log(message);
/*
------------------------------- QUESTION NO 6 ---------------------------------------
...
let message1 = `My Fovorite Number Is: ${favoriteNumber}`;
